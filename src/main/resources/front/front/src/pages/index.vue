        ...
        <el-scrollbar wrap-class="scrollbar-wrapper-horizontal">
          <el-menu
            ...
            :style="{
              ...
              background: 'rgba(226,234,240,.98)',
              display: 'flex',
              width: '86%',
          ...
          >
            ...
            <el-menu-item class="back" @click="goBackend">
              <span
                ...
                class="icon iconfont icon-shuju9"
              ></span>
              <span
                :style="{
                  padding: '0 10px',
      ...
      >
        <div class="swiper-container mySwiper3">
          ...
          <div
            ...
            :style="{ width: '100%', left: '0', bottom: '110px' }"
          ></div>
          <!-- Add Arrows -->
          <div
...
.main-containers .search .input /deep/ .el-input__inner {
  ...
  margin: 0;
  color: #999;
  background: url(http://codegen.caihongy.cn/20231006/d3d4999528a4463b84be7ccbdd1c1524.png)
...
.main-containers .btn-service {
  ...
  margin: 0 10px;
  color: inherit;
  background: url(http://codegen.caihongy.cn/20231006/74238047b48b4786a227a25606642e6d.png)
...
.main-containers .btn-shop {
  ...
  margin: 0 10px;
  color: inherit;
  background: url(http://codegen.caihongy.cn/20231006/efb8028a6ce0422a843a727baa3b4048.png)
    no-repeat left center;
  display: inline-block;
  width: auto;
  font-size: inherit;
