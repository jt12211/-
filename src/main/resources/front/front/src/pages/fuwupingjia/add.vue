...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="社区名称" prop="shequmingcheng">
            <el-input  v-model="ruleForm.shequmingcheng" 
                placeholder="社区名称" clearable :disabled=" false  ||ro.shequmingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="服务分类" prop="fuwufenlei">
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="家庭地址" prop="jiatingdizhi">
            <el-input  v-model="ruleForm.jiatingdizhi" 
                placeholder="家庭地址" clearable :disabled=" false  ||ro.jiatingdizhi"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="服务评分" prop="fuwupingfen">
            <el-select v-model="ruleForm.fuwupingfen" placeholder="请选择服务评分"  >
              <el-option
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="评价时间" prop="pingjiashijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="服务评价" prop="fuwupingjia">
            <editor 
...
<script>
  export default {
      ...
      init(type) {
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.jiatingdizhi!=''&&json.jiatingdizhi) || json.jiatingdizhi==0){
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`fuwupingjia/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('fuwupingjia/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`fuwupingjia/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
