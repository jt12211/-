<template>
  <div :style='{"width":"100%","padding":"0px 7%","margin":"20px auto 40px","position":"relative","background":"none"}'>
    <div :style='{"width":"100%","padding":"12px 0 0","margin":"0 auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231009/482a88d8f9c949feae9ab142374d3473.png) repeat-x center center","height":"60px"}'>
		<div :style='{"padding":"0 20px 0 0","color":"#1e3c4f","textAlign":"left","background":"#fafafa","display":"inline-block","width":"auto","fontSize":"22px","fontWeight":"600"}'>交流论坛</div>
	</div>
    ...
    <div class="section-content" :style='{"border":"0px solid #f6f6f6","width":"100%","padding":"0px 0","margin":"20px auto","position":"relative","background":"none"}'>
      <div class="content-title" :style='{"padding":"0 0px","margin":"0 0 10px","color":"#333","textAlign":"left","width":"100%","lineHeight":"32px","fontSize":"18px","fontWeight":"600","height":"32px"}'>{{detail.title}}</div>
	  ...
	  <div class="operate" :style='{"padding":"0px","alignItems":"center","top":"0","borderRadius":"6px","textAlign":"right","background":"#1e3c4f","display":"inline-block","width":"auto","position":"absolute","right":"0","justifyContent":"flex-end"}'>
      ...
      <div :style='{"border":"0px solid #ddd","color":"#555","padding":"20px 0px"}' class="content-detail" v-html="detail.content"></div>
      
	  
		<div :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"20px auto","background":"none"}'>
			<div :style='{"padding":"0 0 8px 0","borderColor":"#1e3c4f","alignItems":"center","borderWidth":"0 0 2px 0","display":"flex","width":"100%","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
				<div :style='{"color":"#333","fontSize":"16px","fontWeight":"600"}'>评论列表</div>
				<el-button class="pub" type="primary" :style='{"cursor":"pointer","border":"1px solid #1abc9e20","padding":"0px 20px","margin":"0 10px 0 0","color":"#fff","outline":"none","borderRadius":"6px","top":"46px","background":"#1e3c4f","width":"auto","fontSize":"14px","lineHeight":"36px","position":"absolute","height":"36px"}' @click="addComment">
					<span class="icon iconfont icon-xiugai10" :style='{"margin":"0 4px 0 0","fontSize":"14px","color":"#fff","display":"none"}'></span>
					点击评论
				</el-button>
			</div>
			<div class="comment" :style='{"width":"100%","padding":"60px 0 0","background":"none"}'>
				<template v-if="commentList && commentList.length">
				<div class="item" :style='{"border":"1px solid #1e3c4f","padding":"20px 20px 30px","margin":"20px 0 40px","alignItems":"center","color":"#666","background":"#fff","width":"100%","height":"auto"}' v-for="item in commentList" :key="item.id" @mouseenter="commentEnter(item.id)" @mouseleave="commentLeave">
					...
					<div class="btn" :style='{"width":"100%","margin":"12px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"auto"}'>
						<el-button :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#fff","borderRadius":"4px","background":"#1e3c4f","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&showIndex1 == -1" @click="replyClick(item.id)">回复</el-button>
						<el-button :style='{"border":"1px solid #1e3c4f","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#1e3c4f","borderRadius":"4px","background":"none","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&userid==item.userid&&showIndex1 == -1" @click="commentDel(item.id)">删除</el-button>
					</div>
					...
					<div class="comment"  :style='{"width":"100%","padding":"0 20px"}'>
						<div class="item" :style='{"padding":"10px","margin":"20px 0 0 0","borderColor":"#edeff1","alignItems":"center","color":"#666","background":"#fff","borderWidth":"2px 0 0","width":"100%","borderStyle":"solid","height":"auto"}' v-for="items in item.childs" :key="items.id" @mouseenter="commentEnter1(items.id)" @mouseleave="commentLeave1">
							...
							<div class="btn" :style='{"width":"100%","margin":"0px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"auto"}'>
								<el-button :style='{"border":"1px solid #1e3c4f","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#1e3c4f","borderRadius":"4px","background":"none","width":"auto","lineHeight":"30px","fontSize":"14px","height":"30px"}' v-if="showIndex==item.id&&userid==items.userid&&showIndex1==items.id" @click="commentDel(items.id)">删除</el-button>
							</div>
						</div>
					</div>
					</template>
