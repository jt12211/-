<template>
<div class="forum-preview" :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    <div :style='{"width":"100%","padding":"12px 0 0","margin":"30px auto 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231009/482a88d8f9c949feae9ab142374d3473.png) repeat-x center center","height":"60px"}'>
		<div :style='{"padding":"0 20px 0 0","color":"#1e3c4f","textAlign":"left","background":"#fafafa","display":"inline-block","width":"auto","fontSize":"24px","fontWeight":"600"}'>交流论坛</div>
	</div>
    <el-form :style='{"padding":"0px 0","margin":"10px 0 30px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"flex-end","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
		<el-form-item :style='{"margin":"0 0px"}'>
			<el-input v-model="title" placeholder="标题"></el-input>
		</el-form-item>
		<div :style='{"display":"flex"}'>
			<el-button class="searchBtn" type="primary" @click="getForumList(1)">
				<span class="icon iconfont icon-fangdajing01" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}'></span>
				查询
			</el-button>
	...
	<div class="z-box" :style='{"width":"100%","padding":"0px","margin":"20px 0 0","flexWrap":"wrap","display":"flex"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"color":"#333","width":"calc(100% - 0px)","fontSize":"14px"}' class="item-style">{{item.title}}</div>
