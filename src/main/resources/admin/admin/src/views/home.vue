<template>
<div class="content" :style='{"padding":"0 30px 30px","flexWrap":"wrap","display":"flex"}'>
	<!-- notice -->
	<!-- title -->
	...
	<!-- statis -->
	<div :style='{"padding":"30px 0","margin":"10px 0 0 0","alignItems":"center","borderRadius":"5px","flexWrap":"wrap","background":"#fff","display":"flex","width":"60%","justifyContent":"center","order":"1"}'>
		<div :style='{"width":"30%","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('yonghu','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"10px","background":"#EDF4FD","display":"flex","width":"60px","justifyContent":"center","height":"60px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#0F62FE","fontSize":"36px"}'></span>
			</div>
			<div :style='{"width":"calc(100%  - 70px)","margin":"0 0 0 10px","alignItems":"flex-start","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0 0","color":"#333","lineHeight":"24px","fontSize":"20px","fontWeight":"bold","height":"24px","order":"2"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"5px 0 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"width":"30%","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('dingdanxinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"10px","background":"#FCEEE3","display":"flex","width":"60px","justifyContent":"center","height":"60px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#F99126","fontSize":"36px"}'></span>
			</div>
			<div :style='{"width":"calc(100%  - 70px)","margin":"0 0 0 10px","alignItems":"flex-start","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0 0","color":"#333","lineHeight":"24px","fontSize":"20px","fontWeight":"bold","height":"24px","order":"1"}'>{{dingdanxinxiCount}}</div>
				<div :style='{"margin":"5px 0 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>订单信息总数</div>
			</div>
		</div>
		<div :style='{"width":"30%","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('fuwupingjia','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"10px","background":"#E7FBFD","display":"flex","width":"60px","justifyContent":"center","height":"60px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#31CEF6","fontSize":"36px"}'></span>
			</div>
			<div :style='{"width":"calc(100%  - 70px)","margin":"0 0 0 10px","alignItems":"flex-start","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0 0","color":"#333","lineHeight":"24px","fontSize":"20px","fontWeight":"bold","height":"24px","order":"2"}'>{{fuwupingjiaCount}}</div>
				<div :style='{"margin":"5px 0 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>服务评价总数</div>
			</div>
		</div>
		<div :style='{"width":"30%","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('jiankangjilu','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"10px","background":"#E1FBE8","display":"flex","width":"60px","justifyContent":"center","height":"60px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#54E24C","fontSize":"36px"}'></span>
			</div>
			<div :style='{"width":"calc(100%  - 70px)","margin":"0 0 0 10px","alignItems":"flex-start","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0 0","color":"#333","lineHeight":"24px","fontSize":"20px","fontWeight":"bold","height":"24px","order":"2"}'>{{jiankangjiluCount}}</div>
				<div :style='{"margin":"5px 0 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>健康记录总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 4 -->
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","flexWrap":"wrap","background":"transparent","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"2"}'>
		<div id="yonghuChart1" class="echarts1" v-if="isAuth('yonghu','首页统计')"></div>
		<div id="dingdanxinxiChart1" class="echarts2" v-if="isAuth('dingdanxinxi','首页统计')"></div>
		<div id="fuwupingjiaChart1" class="echarts3" v-if="isAuth('fuwupingjia','首页统计')"></div>
		<div id="jiankangjiluChart1" class="echarts4" v-if="isAuth('jiankangjilu','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		this.getfuwupingjiaCount();
		this.fuwupingjiaChat1();
		this.getjiankangjiluCount();
		this.jiankangjiluChat1();
	},
	methods:{
		// 词云
		...
		getfuwupingjiaCount() {
			this.$http({
				url: `fuwupingjia/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.fuwupingjiaCount = data.data
				}
			})
		},
		fuwupingjiaChat1() {
        ...
        var fuwupingjiaChart1 = echarts.init(document.getElementById("fuwupingjiaChart1"),'macarons');
        this.$http({
            url: "fuwupingjia/group/fuwupingfen",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                fuwupingjiaChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    fuwupingjiaChart1.resize();
                };
            }
        });
      })
		...
		getjiankangjiluCount() {
			this.$http({
				url: `jiankangjilu/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.jiankangjiluCount = data.data
				}
			})
		},
		jiankangjiluChat1() {
        ...
        var jiankangjiluChart1 = echarts.init(document.getElementById("jiankangjiluChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangjiluChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    jiankangjiluChart1.resize();
                };
            }
        });
      })
