<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="医院名称" prop="yiyuanmingcheng">
					<el-input  v-model="ruleForm.yiyuanmingcheng" placeholder="医院名称" clearable  :readonly="ro.yiyuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="医院名称" prop="yiyuanmingcheng">
					<el-input v-model="ruleForm.yiyuanmingcheng" placeholder="医院名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="从业年限" prop="congyenianxian">
					<el-input  v-model="ruleForm.congyenianxian" placeholder="从业年限" clearable  :readonly="ro.congyenianxian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="从业年限" prop="congyenianxian">
					<el-input v-model="ruleForm.congyenianxian" placeholder="从业年限" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="个人简介" prop="gerenjianjie">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.gerenjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="工作经验" prop="gongzuojingyan">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.gongzuojingyan" label="工作经验" prop="gongzuojingyan">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gongzuojingyan"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gongzuojingyan = this.ruleForm.gongzuojingyan.replace(reg,'../../../springbootfuca0297/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yiliaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yiliaoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
