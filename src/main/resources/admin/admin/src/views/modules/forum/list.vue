		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px","background":"#fff"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' v-if="!forumChild">
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#9E9E9E","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">帖子标题</label>
				...
				<el-row :style='{"display":"block"}' v-if="forumChild">
					<el-button :style='{"border":"1px solid #0E9BD3","cursor":"pointer","padding":"0 14px","outline":"none","color":"#0E9BD3","borderRadius":"4px","background":"transparent","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="search()">返回</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="forumChild" prop="content" label="帖子内容">
						<template slot-scope="scope">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="!forumChild" prop="istop" label="是否置顶">
						<template slot-scope="scope">
                            <el-switch
					...
					<el-table-column :resizable='true' :sortable='false' v-if="!forumChild" prop="toptime" label="置顶时间">
						<template slot-scope="scope">
                            {{scope.row.toptime}}
						</template>
					</el-table-column>
