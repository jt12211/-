  ...
  <div :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
    ...
    >
      ...
      <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
		<el-button class="btn3" :style='{"border":"0","cursor":"pointer","padding":"0 14px","margin":"4px","outline":"none","color":"#fff","borderRadius":"5px","background":"#0E9BD3","width":"auto","fontSize":"14px","float":"right","height":"40px"}' type="primary" @click="onUpdateHandler">
